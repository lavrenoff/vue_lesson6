<template>
    <footer class="footer center">
                ...
                <div class="footer__right">
                    ...
                    <p class="footer__pp">55 East Birchwood Ave. Brooklyn, New York
                        11201</p>
                    <p class="footer__pp footer__ppp">contact@interno.com</p>
                    <p class="footer__pp">(123) 456 - 7890</p>
                </div>
            </footer></template>
